      ...
      <div style="border: 3px solid black; height: 100%;">
        ...
        <div style="padding: 30px; height: 100%;">
          ...
          <table style="margin-top: 20px;">
            <tbody>
              <tr><td>Volume</td>         <td style="padding-left:10px;padding-right:10px">:</td> <td><b>${article.volume}</b></td></tr>
              <tr><td>Issue</td>          <td style="padding-left:10px;padding-right:10px">:</td> <td><b>${article.issue}</b></td></tr>
              <tr><td>Year</td>           <td style="padding-left:10px;padding-right:10px">:</td> <td><b>${article.year}</b></td></tr>
              <tr><td>Page Number</td>    <td style="padding-left:10px;padding-right:10px">:</td> <td><b>${article.pagenumber}</b></td></tr>
              <tr><td>Reference No.</td>  <td style="padding-left:10px;padding-right:10px">:</td> <td><b>${article.refnumber}</b></td></tr>
